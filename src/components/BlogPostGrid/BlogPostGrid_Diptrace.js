...
function BlogPostGrid_Diptrace() {
  return (
    <StaticQuery
      query={blogPostQuery_Diptrace}
      render={data => {
...
const blogPostQuery_Diptrace = graphql`
  query BlogPostQuery_Diptrace {
    allMarkdownRemark(
      filter: { fileAbsolutePath: { regex: "/diptrace-workshop/" } }
...
export default BlogPostGrid_Diptrace
